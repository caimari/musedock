...
<div class="app-content">
  <div class="container-fluid">
    ...
    <form method="POST" action="{{ festival_admin_url('categories') }}">
      @csrf
      <div class="card" style="max-width:700px">
        <div class="card-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="slug" value="{{ old('slug', $category->slug ?? '') }}" placeholder="auto-generado">
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="url" class="form-control" name="image" value="{{ old('image', $category->image ?? '') }}" placeholder="URL de imagen">
          </div>
          <hr>
          <div class="mb-3">
