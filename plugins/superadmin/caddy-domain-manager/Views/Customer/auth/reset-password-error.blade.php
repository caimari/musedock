            ...
            <div class="card shadow-lg border-0">
                <div class="card-body p-5 text-center">
                    <div class="mb-4">
                        ...
                        <h1 class="h2 fw-bold text-danger">Enlace Inválido</h1>
                        <p class="text-muted mt-3"><?= htmlspecialchars($error) ?></p>
                    </div>

                    <div class="d-grid gap-2">
                        <a href="/customer/forgot-password" class="btn btn-primary btn-lg">
