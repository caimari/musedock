...
class SourcesController
{
    ...
    public function store()
    {
        ...
        try {
            ...
            $_SESSION['success'] = $lang['sources_created'];
    ...
    public function update(int $id)
    {
        ...
        try {
            ...
            $_SESSION['success'] = $lang['sources_updated'];
        } catch (\Exception $e) {
            $_SESSION['error'] = $e->getMessage();
        }
    ...
    public function destroy(int $id)
    {
        ...
        try {
            Source::delete($id);
            $_SESSION['success'] = $lang['sources_deleted'];
        } catch (\Exception $e) {
            $_SESSION['error'] = $e->getMessage();
        }
    ...
    public function fetch(int $id)
    {
        ...
        if (!$source || $source->tenant_id != $tenantId) {
            $_SESSION['error'] = $lang['error_source_not_found'];
            header('Location: /admin/plugins/news-aggregator/sources');
            exit;
        }
        ...
        if ($result['success']) {
            $_SESSION['success'] = str_replace(':count', $result['count'], $lang['sources_fetch_success']);
        } else {
            $_SESSION['error'] = str_replace(':error', $result['error'], $lang['sources_fetch_error']);
        }
