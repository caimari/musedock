...
Route::post("/{$adminPath}/plugins/news-aggregator/items/{id}/extract-context", 'NewsAggregator\Controllers\ItemsController@extractContext')
    ->name('news-aggregator.items.extract-context')
    ->middleware('auth');

Route::post("/{$adminPath}/plugins/news-aggregator/items/{id}/toggle-source-context", 'NewsAggregator\Controllers\ItemsController@toggleSourceContext')
    ->name('news-aggregator.items.toggle-source-context')
    ->middleware('auth');

Route::post("/{$adminPath}/plugins/news-aggregator/items/{id}/research", 'NewsAggregator\Controllers\ItemsController@research')
    ->name('news-aggregator.items.research')
    ->middleware('auth');

Route::post("/{$adminPath}/plugins/news-aggregator/items/{id}/toggle-research-context", 'NewsAggregator\Controllers\ItemsController@toggleResearchContext')
    ->name('news-aggregator.items.toggle-research-context')
    ->middleware('auth');
