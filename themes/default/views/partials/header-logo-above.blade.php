...
<header class="musedock-header {{ $headerSticky ? 'enable-sticky' : '' }} header-layout-logo-above" id="main-header">
    {{-- Logo row: logo centered, social+search right aligned to logo height --}}
    <div class="header-logo-above-brand" style="padding:24px 0 16px;border-bottom:1px solid rgba(0,0,0,0.06);background:var(--header-bg-color,#fff);">
        <div class="container">
            <div class="logo-above-brand-row">
                ...
                <div class="logo-above-brand-side logo-above-brand-left"></div>

                {{-- Logo center --}}
                <div class="logo-above-brand-center">
                ...
                <div class="logo-above-brand-side logo-above-brand-right">
    ...
    {{-- Navigation bar: menu left, date right --}}
    @php
