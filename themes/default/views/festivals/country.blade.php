...
@section('description', 'Descubre los festivales en ' . $countryName . '. Directorio completo y actualizado.')
...
<div class="container py-5">
  ...
  <div class="mb-4">
    <h1 class="h3"><i class="bi bi-geo-alt me-2"></i>{{ $title }}</h1>
  ...
  <div class="text-center py-5">
    <p class="text-muted">No se encontraron festivales en {{ $countryName }}.</p>
