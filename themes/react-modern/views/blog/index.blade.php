...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="text-center mb-12">
        ...
        <p class="text-lg text-gray-600 max-w-2xl mx-auto">{{ setting('site_description', '') }}</p>
    </div>
    ...
    @else
        ...
        <div class="text-center py-16">
            ...
            <h3 class="mt-4 text-lg font-medium text-gray-900">{{ __('blog.no_posts') }}</h3>
            <p class="mt-2 text-gray-500">No hay publicaciones disponibles en este momento.</p>
        </div>
    @endif
</div>
