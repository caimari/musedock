                        ...
                        <div class="card-body" id="contentFields">
                            ...
                            @if($element->type === 'hero')
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    @if(!$isReadOnly)
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="hero_image_url_sa_edit" name="data[image_url]" value="{{ old('data.image_url', $data['image_url'] ?? '') }}" placeholder="URL de la imagen">
                                            <button type="button" class="btn btn-outline-secondary open-media-modal-button"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#mediaManagerModal"
                                                    data-input-target="#hero_image_url_sa_edit"
                                                    data-preview-target="#hero_image_preview_sa_edit">
                                                <i class="bi bi-image me-1"></i> Seleccionar Imagen
                                            </button>
                                        </div>
                                        <img id="hero_image_preview_sa_edit" src="{{ old('data.image_url', $data['image_url'] ?? '') }}" class="img-fluid rounded border mt-2" style="max-height: 150px; {{ (old('data.image_url', $data['image_url'] ?? '') ? '' : 'display: none;') }}">
                                    @else
