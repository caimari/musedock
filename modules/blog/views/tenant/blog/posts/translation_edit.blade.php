  ...
  <div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div class="breadcrumb">
          <a href="{{ route('tenant.blog.posts.index') }}">Posts</a>
          <span class="mx-2">/</span>
          <a href="{{ route('tenant.blog.posts.edit', ['id' => $post->id]) }}">{{ e($post->title) }}</a>
          <span class="mx-2">/</span>
          <span>{{ isset($translation->id) ? "Editar Traducción ({$localeName})" : "Crear Traducción ({$localeName})" }}</span>
        </div>
         <a href="{{ route('tenant.blog.posts.edit', ['id' => $post->id]) }}" class="btn btn-sm btn-outline-secondary">
    ...
    <form method="POST" action="{{ route('tenant.blog.posts.translation.update', ['id' => $post->id, 'locale' => $locale]) }}" id="translationForm">
        @csrf
        @method('PUT')
                ...
                <div class="card sticky-top" style="top: 1rem;">
                     ...
                     <div class="card-body">
                        ...
                        <div class="d-grid gap-2">
                             ...
                             <a href="{{ route('tenant.blog.posts.edit', ['id' => $post->id]) }}" class="btn btn-secondary">
