...
<div class="app-content">
  <div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
      <form method="GET" action="{{ admin_url('blog/tags') }}" class="d-flex align-items-center">
        ...
        @if (!empty($search))
          <a href="{{ admin_url('blog/tags') }}" class="btn btn-outline-danger btn-sm">{{ __('common.clear_filter') }}</a>
        @endif
      </form>
    </div>

    {{-- Formulario Acciones en Lote --}}
    <form method="POST" action="{{ admin_url('blog/tags/bulk') }}" id="bulkActionForm">
      @csrf
      <div class="card">
            ...
            @foreach ($tags as $tag)
              <tr data-id="{{ $tag->id }}">
                ...
                <td>
                  ...
                  <br>
                  <small>
                    <a href="{{ admin_url('blog/tags/' . $tag->id . '/edit') }}">{{ __('common.edit') }}</a>
                     |
