  ...
  <div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
      <div class="breadcrumb">
        <a href="{{ route('tenant.blog.tags.index') }}">Etiquetas</a> <span class="mx-2">/</span> <span>{{ e($tag->name) }}</span>
      </div>
    ...
    <form method="POST" action="{{ route('tenant.blog.tags.update', ['id' => $tag->id]) }}" id="tagForm">
      @csrf
      @method('PUT')
