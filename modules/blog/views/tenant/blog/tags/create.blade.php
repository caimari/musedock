  ...
  <div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
      <div class="breadcrumb">
        <a href="{{ admin_url('blog/tags') }}">Etiquetas</a> <span class="mx-2">/</span> <span>Nueva etiqueta</span>
      </div>
    ...
    <form method="POST" action="{{ admin_url('blog/tags') }}" id="tagForm">
      @csrf
        ...
        <div class="col-md-3">
          ...
          <div class="card">
            <div class="card-body text-center">
              <a href="{{ admin_url('blog/tags') }}" class="btn btn-sm btn-outline-secondary">{{ __('common.cancel') }}</a>
            </div>
          </div>
        </div>
      </div>
