  ...
  <div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
      <div class="breadcrumb">
        <a href="{{ admin_url('blog/categories') }}">{{ __('blog.categories') }}</a> <span class="mx-2">/</span> <span>{{ e($category->name) }}</span>
      </div>
    ...
    <form method="POST" action="{{ admin_url('blog/categories/' . $category->id) }}" id="categoryForm" enctype="multipart/form-data">
      @csrf
      @method('PUT')
