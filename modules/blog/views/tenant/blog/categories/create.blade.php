  ...
  <div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
      <div class="breadcrumb">
        <a href="{{ route('tenant.blog.categories.index') }}">{{ __('blog.categories') }}</a> <span class="mx-2">/</span> <span>{{ __('blog.category.new_category') }}</span>
      </div>
    ...
    <form method="POST" action="{{ route('tenant.blog.categories.store') }}" id="categoryForm" enctype="multipart/form-data">
      @csrf
        ...
        <div class="col-md-3">
          ...
          <div class="card">
            <div class="card-body text-center">
              <a href="{{ route('tenant.blog.categories.index') }}" class="btn btn-sm btn-outline-secondary">{{ __('common.cancel') }}</a>
            </div>
          </div>
        </div>
      </div>
