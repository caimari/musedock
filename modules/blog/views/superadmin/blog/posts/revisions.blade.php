...
<div class="app-content">
  <div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
      <h2>{{ $title }}</h2>
      <div>
        <a href="/musedock/blog/posts/{{ $post->id }}/edit" class="btn btn-secondary me-2">
          <i class="bi bi-arrow-left"></i> Volver a editar
        </a>
        <a href="/musedock/blog/posts" class="btn btn-outline-secondary">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
      <form method="POST" action="/musedock/blog/posts/{{ $post->id }}/revisions/bulk" id="bulkRevisionsForm" class="d-flex align-items-center gap-2">
              ...
              <tr class="revision-row">
                ...
                <td>
                  <div class="d-inline-flex align-items-center gap-2">
                    <a href="/musedock/blog/posts/{{ $post->id }}/revisions/{{ $revision->id }}/preview"
                       class="btn btn-outline-secondary btn-sm"
                       title="{{ __('pages.preview_revision') }}">
                      <i class="bi bi-eye"></i>
                    </a>
                    <form method="POST"
                          action="/musedock/blog/posts/{{ $post->id }}/revisions/{{ $revision->id }}/restore"
                    ...
                    <form method="POST"
                          action="/musedock/blog/posts/{{ $post->id }}/revisions/{{ $revision->id }}/delete"
...
function compareSelected() {
  if (selectedRevisions.length === 2) {
    window.location.href = `/musedock/blog/posts/{{ $post->id }}/revisions/${selectedRevisions[0]}/compare/${selectedRevisions[1]}`;
  }
}
