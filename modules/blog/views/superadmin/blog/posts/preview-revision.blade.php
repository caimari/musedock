    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div>
                ...
                <form method="POST" action="/musedock/blog/posts/{{ $post->id }}/revisions/{{ $revision->id }}/restore" style="display:inline;" onsubmit="return confirm('¿Restaurar a esta versión?');">
