  ...
  <div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
      <div class="breadcrumb mb-0">
        <a href="/shop/account/orders">Mis pedidos</a>
        <span class="mx-2">/</span>
        <span>{{ e($order->order_number) }}</span>
      </div>
      <a href="/shop/account/orders" class="btn btn-sm btn-outline-secondary"><i class="bi bi-arrow-left me-1"></i> Volver</a>
    </div>

    <div class="row">
      <div class="col-lg-8">
        <div class="card mb-3">
          <div class="card-header"><h5 class="mb-0">Artículos</h5></div>
          <div class="card-body p-0">
            <table class="table mb-0">
              ...
              <tfoot class="table-light">
                ...
                <tr class="text-success"><td colspan="3" class="text-end">Descuento:</td><td class="text-end">-{{ $order->getFormattedDiscount() }}</td></tr>
                @endif
                <tr><td colspan="3" class="text-end">IVA ({{ $order->tax_rate }}%):</td><td class="text-end">{{ $order->getFormattedTax() }}</td></tr>
