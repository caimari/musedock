...
class CreateBlogCategoriesTable_2025_12_11_102213
{
    public function up()
    {
  ...
  UNIQUE (tenant_id, slug)
            ...
            // Create indexes
            $pdo->exec("CREATE INDEX blog_categories_idx_tenant_id ON blog_categories(tenant_id)");
            $pdo->exec("CREATE INDEX blog_categories_idx_parent_id ON blog_categories(parent_id)");
            $pdo->exec("CREATE INDEX blog_categories_idx_slug ON blog_categories(slug)");
            $pdo->exec("CREATE INDEX blog_categories_idx_order ON blog_categories("order")");
            $pdo->exec("CREATE INDEX blog_categories_idx_blog_categories_deleted_at ON blog_categories(deleted_at)");
            $pdo->exec("CREATE INDEX blog_categories_idx_blog_categories_tenant ON blog_categories(tenant_id)");
            $pdo->exec("CREATE INDEX blog_categories_idx_blog_categories_slug ON blog_categories(slug)");
            $pdo->exec("CREATE INDEX blog_categories_idx_blog_categories_parent ON blog_categories(parent_id)");
