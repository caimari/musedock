...
class CreateUsersTable_2025_12_11_091120
{
    public function up()
    {
  ...
  UNIQUE (email)
            ...
            // Create indexes
            $pdo->exec("CREATE INDEX idx_email_tenant ON users(email, tenant_id)");
            $pdo->exec("CREATE INDEX idx_users_tenant ON users(tenant_id)");
            $pdo->exec("CREATE INDEX idx_users_email ON users(email)");
            $pdo->exec("CREATE INDEX idx_users_2fa ON users(two_factor_enabled)");
        }
