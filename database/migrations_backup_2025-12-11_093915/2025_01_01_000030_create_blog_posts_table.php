...
class CreateBlogPostsTable_2025_12_11_091120
{
    public function up()
    {
  ...
  UNIQUE (tenant_id, slug)
            ...
            // Create indexes
            $pdo->exec("CREATE INDEX idx_tenant_id ON blog_posts(tenant_id)");
            $pdo->exec("CREATE INDEX idx_user_id ON blog_posts(user_id)");
            $pdo->exec("CREATE INDEX idx_user_type ON blog_posts(user_type)");
            $pdo->exec("CREATE INDEX idx_slug ON blog_posts(slug)");
            $pdo->exec("CREATE INDEX idx_status ON blog_posts(status)");
            $pdo->exec("CREATE INDEX idx_visibility ON blog_posts(visibility)");
            $pdo->exec("CREATE INDEX idx_published_at ON blog_posts(published_at)");
            $pdo->exec("CREATE INDEX idx_featured ON blog_posts(featured)");
            $pdo->exec("CREATE INDEX idx_created_at ON blog_posts(created_at)");
            $pdo->exec("CREATE INDEX idx_blog_posts_deleted_at ON blog_posts(deleted_at)");
            $pdo->exec("CREATE INDEX idx_blog_posts_tenant ON blog_posts(tenant_id)");
            $pdo->exec("CREATE INDEX idx_blog_posts_status ON blog_posts(status)");
            $pdo->exec("CREATE INDEX idx_blog_posts_published ON blog_posts(published_at)");
            $pdo->exec("CREATE INDEX idx_blog_posts_slug ON blog_posts(slug)");
            $pdo->exec("CREATE INDEX idx_blog_posts_tenant_status ON blog_posts(tenant_id, status)");
            $pdo->exec("CREATE INDEX idx_blog_posts_deleted ON blog_posts(deleted_at)");
