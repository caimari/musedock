...
class CreateReactSlidersTable_2025_12_11_091120
{
    public function up()
    {
  ...
  UNIQUE (identifier, tenant_id)
            ...
            // Create indexes
            $pdo->exec("CREATE INDEX tenant_id ON react_sliders(tenant_id)");
            $pdo->exec("CREATE INDEX is_active ON react_sliders(is_active)");
