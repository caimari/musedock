...
class CreateCustomFormFieldsTable_2025_12_11_091120
{
    public function up()
    {
  ...
  UNIQUE (form_id, field_name)
            ...
            // Create indexes
            $pdo->exec("CREATE INDEX idx_form_id ON custom_form_fields(form_id)");
            $pdo->exec("CREATE INDEX idx_sort_order ON custom_form_fields(sort_order)");
            $pdo->exec("CREATE INDEX idx_field_type ON custom_form_fields(field_type)");
