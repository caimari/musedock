...
class CreateSuperadminPluginsTable_2025_12_11_091120
{
    public function up()
    {
  ...
  UNIQUE (slug)
            ...
            // Create indexes
            $pdo->exec("CREATE INDEX is_active ON superadmin_plugins(is_active)");
            $pdo->exec("CREATE INDEX is_installed ON superadmin_plugins(is_installed)");
