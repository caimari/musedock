...
class CreateSuperadminPluginMenusTable_2025_12_11_091120
{
    public function up()
    {
  ...
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
            ...
            // Create indexes
            $pdo->exec("CREATE INDEX plugin_id ON superadmin_plugin_menus(plugin_id)");
            $pdo->exec("CREATE INDEX parent_id ON superadmin_plugin_menus(parent_id)");
            $pdo->exec("CREATE INDEX is_active ON superadmin_plugin_menus(is_active)");
