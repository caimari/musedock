...
class CreateCustomFormsTable_2025_12_11_091120
{
    public function up()
    {
  ...
  UNIQUE (slug, tenant_id)
            ...
            // Create indexes
            $pdo->exec("CREATE INDEX idx_tenant_id ON custom_forms(tenant_id)");
            $pdo->exec("CREATE INDEX idx_is_active ON custom_forms(is_active)");
            $pdo->exec("CREATE INDEX idx_created_at ON custom_forms(created_at)");
