...
class CreateTenantPluginsTable_2025_12_11_091120
{
    public function up()
    {
  ...
  UNIQUE (tenant_id, slug)
            ...
            // Create indexes
            $pdo->exec("CREATE INDEX idx_tenant_id ON tenant_plugins(tenant_id)");
            $pdo->exec("CREATE INDEX idx_active ON tenant_plugins(active)");
            $pdo->exec("CREATE INDEX idx_slug ON tenant_plugins(slug)");
