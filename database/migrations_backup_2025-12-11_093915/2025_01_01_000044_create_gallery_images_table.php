...
class CreateGalleryImagesTable_2025_12_11_091120
{
    public function up()
    {
  ...
  CHECK (link_target IN ('_self', '_blank'))
            ...
            // Create indexes
            $pdo->exec("CREATE INDEX idx_gallery_id ON gallery_images(gallery_id)");
            $pdo->exec("CREATE INDEX idx_sort_order ON gallery_images(sort_order)");
            $pdo->exec("CREATE INDEX idx_is_active ON gallery_images(is_active)");
            $pdo->exec("CREATE INDEX idx_file_hash ON gallery_images(file_hash)");
            $pdo->exec("CREATE INDEX idx_public_token ON gallery_images(public_token)");
