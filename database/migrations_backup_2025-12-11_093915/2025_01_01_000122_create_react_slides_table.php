...
class CreateReactSlidesTable_2025_12_11_091120
{
    public function up()
    {
  ...
  CHECK (button_target IN ('_self', '_blank'))
            ...
            // Create indexes
            $pdo->exec("CREATE INDEX slider_id ON react_slides(slider_id)");
            $pdo->exec("CREATE INDEX sort_order ON react_slides(sort_order)");
            $pdo->exec("CREATE INDEX is_active ON react_slides(is_active)");
