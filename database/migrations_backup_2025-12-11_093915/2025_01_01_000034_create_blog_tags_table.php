...
class CreateBlogTagsTable_2025_12_11_091120
{
    public function up()
    {
  ...
  UNIQUE (tenant_id, slug)
            ...
            // Create indexes
            $pdo->exec("CREATE INDEX idx_tenant_id ON blog_tags(tenant_id)");
            $pdo->exec("CREATE INDEX idx_slug ON blog_tags(slug)");
            $pdo->exec("CREATE INDEX idx_blog_tags_deleted_at ON blog_tags(deleted_at)");
            $pdo->exec("CREATE INDEX idx_blog_tags_tenant ON blog_tags(tenant_id)");
            $pdo->exec("CREATE INDEX idx_blog_tags_slug ON blog_tags(slug)");
