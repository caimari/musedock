...
class CreateTenantThemesTable_2025_12_11_091120
{
    public function up()
    {
  ...
  UNIQUE (tenant_id, slug)
            ...
            // Create indexes
            $pdo->exec("CREATE INDEX idx_tenant_id ON tenant_themes(tenant_id)");
            $pdo->exec("CREATE INDEX idx_active ON tenant_themes(active)");
            $pdo->exec("CREATE INDEX idx_validated ON tenant_themes(validated)");
