...
class CreateImageGalleriesTable_2025_12_11_091120
{
    public function up()
    {
  ...
  UNIQUE (slug, tenant_id)
            ...
            // Create indexes
            $pdo->exec("CREATE INDEX idx_tenant_id ON image_galleries(tenant_id)");
            $pdo->exec("CREATE INDEX idx_is_active ON image_galleries(is_active)");
            $pdo->exec("CREATE INDEX idx_featured ON image_galleries(featured)");
            $pdo->exec("CREATE INDEX idx_layout_type ON image_galleries(layout_type)");
