...
class CreateCustomFormSubmissionsTable_2025_12_11_091120
{
    public function up()
    {
  ...
  updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
            ...
            // Create indexes
            $pdo->exec("CREATE INDEX idx_form_id ON custom_form_submissions(form_id)");
            $pdo->exec("CREATE INDEX idx_created_at ON custom_form_submissions(created_at)");
            $pdo->exec("CREATE INDEX idx_is_read ON custom_form_submissions(is_read)");
            $pdo->exec("CREATE INDEX idx_is_starred ON custom_form_submissions(is_starred)");
            $pdo->exec("CREATE INDEX idx_is_spam ON custom_form_submissions(is_spam)");
