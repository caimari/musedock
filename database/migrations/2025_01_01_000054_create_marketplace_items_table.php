...
class CreateMarketplaceItemsTable_2025_12_11_104033
{
    public function up()
    {
  ...
  UNIQUE (slug, \"type\")
            ...
            // Create indexes
            $pdo->exec("CREATE INDEX marketplace_items_idx_type ON marketplace_items(\"type\")");
            $pdo->exec("CREATE INDEX marketplace_items_idx_installed_at ON marketplace_items(installed_at)");
