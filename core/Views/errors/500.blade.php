<?php
// 🔒 SECURITY: NUNCA mostrar stack traces en producción
// Solo mostrar información sensible si estamos en entorno de desarrollo LOCAL
$config = require __DIR__ . '/../../../config/config.php';
$isLocal = in_array($_SERVER['REMOTE_ADDR'] ?? '', ['127.0.0.1', '::1', 'localhost'], true);
$debug = ($config['debug'] ?? false) && $isLocal;
...
// Si hay una excepción guardada en la sesión, solo mostrarla en desarrollo local
$exception = $debug ? ($_SESSION['last_exception'] ?? null) : null;
?>
<!DOCTYPE html>
<html lang="es">
<head>
