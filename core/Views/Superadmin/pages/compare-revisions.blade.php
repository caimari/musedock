...
<div class="d-flex justify-content-between align-items-center mb-3"><h2>{{ $title }}</h2><a href="/musedock/pages/{{ $page->id }}/revisions" class="btn btn-secondary"><i class="bi bi-arrow-left"></i> {{ __('pages.back_to_revisions') }}</a></div>
