...
<h2>{{ $title }}</h2>
<div><a href="/musedock/pages/{{ $page->id }}/edit" class="btn btn-secondary me-2"><i class="bi bi-arrow-left"></i> Volver a editar</a><a href="/musedock/pages" class="btn btn-outline-secondary"><i class="bi bi-list"></i> Lista de páginas</a></div>
</div>
