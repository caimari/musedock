...
document.addEventListener('DOMContentLoaded', function() {
    ...
    setTimeout(function() {
        // If Chrome filled twitter_image with something that's NOT a URL (like an email), nuke it
        if (twitterImageInput) {
            ...
            if (!isUrl) {
                // Chrome put junk (email) in this field — restore the real saved value
                twitterImageInput.value = savedTwitterImage;
            }
            // If still empty, use featured image
