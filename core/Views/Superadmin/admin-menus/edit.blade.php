...
@section('title', $title ?? 'Editar Menú del Administrador')
...
<div class="app-content">
  <div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
      <h2>{{ $title ?? 'Editar Menú del Administrador' }}</h2>
    ...
    <div class="card">
      <div class="card-body">
        <form method="POST" action="{{ route('admin-menus.update', ['id' => $menu->id]) }}" id="menuForm">
          @csrf
            ...
            <div class="col-md-12 mb-3">
              ...
              <div class="d-flex gap-4">
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" id="show_in_superadmin" name="show_in_superadmin"
                         {{ ($menu->show_in_superadmin ?? 1) ? 'checked' : '' }}>
                ...
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" id="show_in_tenant" name="show_in_tenant"
                         {{ ($menu->show_in_tenant ?? 1) ? 'checked' : '' }}>
          ...
          <div class="row">
            ...
            <div class="col-md-4 mb-3">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" id="icon" name="icon" value="{{ $menu->icon }}" placeholder="app">
            ...
            <div class="col-md-2 mb-3">
              ...
              <select class="form-select" id="icon_type" name="icon_type">
                ...
                <option value="fas" {{ $menu->icon_type === 'fas' ? 'selected' : '' }}>FA Solid</option>
                <option value="far" {{ $menu->icon_type === 'far' ? 'selected' : '' }}>FA Regular</option>
                <option value="fal" {{ $menu->icon_type === 'fal' ? 'selected' : '' }}>FA Light</option>
              </select>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-12 mb-3">
              ...
              <input type="text" class="form-control" id="permission" name="permission" value="{{ $menu->permission }}" placeholder="admin.settings.view">
