                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select" id="provider_type" name="provider_type" required>
                            ...
                            <option value="ollama" {{ old('provider_type', $provider['provider_type']) == 'ollama' ? 'selected' : '' }}>Ollama (Local)</option>
                            <option value="minimax" {{ old('provider_type', $provider['provider_type']) == 'minimax' ? 'selected' : '' }}>MiniMax</option>
