            ...
            <tbody>
              @foreach ($menus as $menu)
                <tr>
                  ...
                  <td>
                    <a href="{{ route('menus.edit', ['id' => $menu->id]) }}" class="btn btn-sm btn-primary">
                      <i class="bi bi-pencil"></i> Editar
                    </a>
                    <form action="{{ route('menus.delete', ['id' => $menu->id]) }}" method="POST" class="d-inline-block" onsubmit="return confirm('¿Seguro que quieres eliminar este menú? Se eliminarán también todos sus elementos.');">
                      @csrf
