...
@push('scripts')
<script>
function syncAliasDnsProviderUI() {
...
document.getElementById('dns_provider')?.addEventListener('change', syncAliasDnsProviderUI);
document.getElementById('skip_cloudflare').addEventListener('change', syncAliasDnsProviderUI);
syncAliasDnsProviderUI();
</script>
@endpush
