...
<div class="app-content">
    <div class="container-fluid">
        ...
        @include('plugins.news-aggregator._nav', ['activeTab' => 'logs', 'tenantId' => $tenantId ?? 0, 'tenants' => $tenants ?? []])
        ...
        @else
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white d-flex justify-content-between align-items-center">
                    ...
                    <form action="/musedock/news-aggregator/logs/clear" method="POST" class="d-inline"
