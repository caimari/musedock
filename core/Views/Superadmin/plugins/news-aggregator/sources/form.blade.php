...
<div class="app-content">
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="/musedock/news-aggregator/sources?tenant={{ $tenantId }}" class="btn btn-outline-secondary btn-sm">
            ...
            <div class="card-body">
                @php
                    $formAction = $action === 'edit'
                        ? '/musedock/news-aggregator/sources/' . $source->id . '/update'
                        : '/musedock/news-aggregator/sources';
                ...
                <form action="{{ $formAction }}" method="POST">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="/musedock/news-aggregator/sources?tenant={{ $tenantId }}" class="btn btn-outline-secondary">
                            Cancelar
                        </a>
                    </div>
                </form>
