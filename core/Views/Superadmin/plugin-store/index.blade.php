...
<div class="container-fluid py-4">
        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Plugins y modulos premium para tu instalacion MuseDock</p>
                </div>
                <a href="/musedock/plugins" class="btn btn-outline-secondary btn-sm">
    ...
    <div class="alert alert-info">
        ...
        No hay productos disponibles en este momento. Comprueba la conexion con el servidor de licencias.
    </div>
    @else
    <div class="row g-4">
