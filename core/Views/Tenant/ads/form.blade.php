...
<div class="app-content">
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="/{{ admin_path() }}/ads" class="btn btn-outline-secondary">
        ...
        <form method="POST"
              action="/{{ admin_path() }}/ads{{ $ad ? '/' . $ad->id . '/update' : '' }}"
              id="ad-form">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card mb-3" id="image-fields">
                        ...
                        <div class="card-body">
                            @php $mediaModuleActive = function_exists('is_module_active') ? is_module_active('media-manager') : false; @endphp
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <button type="button" class="btn btn-primary open-media-modal-button"
                                            data-input-target="#image_url"
                                            data-preview-target="#image-preview-img"
                                            title="Seleccionar imagen">
                                        <i class="fas fa-photo-video"></i> Medios
                                    </button>
                                    @endif
                                </div>
                                @if(!$mediaModuleActive)
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // When media manager sets the input value, update preview
...
<script>
// Wire up .open-media-modal-button clicks to the media manager
document.addEventListener('DOMContentLoaded', function() {
    document.body.addEventListener('click', function(e) {
        ...
        if (window.openMediaManagerForTinyMCE) {
            // Override the callback to set the input + preview
            window.__adsMediaCallback = function(url) {
                if (inputTarget) {
                    const input = document.querySelector(inputTarget);
                    if (input) { input.value = url; input.dispatchEvent(new Event('change')); }
                }
                if (previewTarget) {
                    const img = document.querySelector(previewTarget);
                    if (img) { img.src = url; img.style.display = ''; }
                }
            };
            window.openMediaManagerForTinyMCE(function(url) {
                if (window.__adsMediaCallback) window.__adsMediaCallback(url);
            });
        }
    });
});
