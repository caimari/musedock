...
@section('content')
<div class="theme-appearance-manager">
    <!-- Header -->
    <div class="appearance-header mb-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-1">
                        <li class="breadcrumb-item"><a href="/{{ admin_path() }}/themes">Temas</a></li>
            ...
            <div class="d-flex gap-2 flex-wrap">
                <button type="button" class="btn btn-outline-secondary" id="btn-presets">
...
<style>
.theme-appearance-manager .appearance-section .card-header {
    border-bottom: 2px solid #e9ecef;
}

.theme-appearance-manager .form-control-color {
    width: 60px;
    padding: 0.375rem;
}

.theme-appearance-manager .color-hex-input {
    font-family: monospace;
}

.theme-appearance-manager .code-editor {
    ...
    document.getElementById('btn-save-preset')?.addEventListener('click', function() {
        Swal.fire({
            ...
            html: `
                ...
                <input type="text" id="preset-name-input" class="form-control" placeholder="Nombre del preset">
            `,
            showCancelButton: true,
            ...
            if (result.isConfirmed) {
                ...
                fetch(`/{{ admin_path() }}/themes/appearance/${themeSlug}/preset/save`, {
                    method: 'POST',
                    headers: {
        ...
        btn.addEventListener('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    form.action = `/{{ admin_path() }}/themes/appearance/${themeSlug}/preset/load/${presetSlug}`;
                    form.submit();
                }
            });
        });
    ...
    document.querySelectorAll('.btn-delete-preset').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    fetch(`/{{ admin_path() }}/themes/appearance/${themeSlug}/preset/delete/${presetSlug}`, {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/x-www-form-urlencoded',
                        },
