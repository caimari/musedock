        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-body py-3">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <form action="{{ admin_url('/plugins/news-aggregator/run-pipeline') }}" method="POST" class="ms-3">
                        @csrf
            ...
            <div class="col-md-8">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ admin_url('/plugins/news-aggregator/items') }}" class="btn btn-sm btn-outline-primary">Ver todo</a>
                    </div>
            ...
            <div class="col-md-4">
                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body d-grid gap-2">
                        <a href="{{ admin_url('/plugins/news-aggregator/sources/create') }}" class="btn btn-outline-primary">
                            <i class="bi bi-plus-circle"></i> Añadir fuente
                        </a>
                        <a href="{{ admin_url('/plugins/news-aggregator/items?status=ready') }}" class="btn btn-outline-warning">
                            <i class="bi bi-eye"></i> Revisar pendientes
                        </a>
                        <a href="{{ admin_url('/plugins/news-aggregator/settings') }}" class="btn btn-outline-secondary">
