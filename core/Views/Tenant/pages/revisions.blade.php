...
<div class="app-content">
  <div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
      <form method="POST" action="{{ admin_url('pages') }}/{{ $page->id }}/revisions/bulk" id="bulkRevisionsForm" class="d-flex align-items-center gap-2">
...
function compareSelected() {
  if (selectedRevisions.length === 2) {
    window.location.href = `{{ admin_url('pages') }}/{{ $page->id }}/revisions/${selectedRevisions[0]}/compare/${selectedRevisions[1]}`;
  }
}
