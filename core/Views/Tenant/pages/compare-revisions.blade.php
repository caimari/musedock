...
<div class="d-flex justify-content-between align-items-center mb-3"><h2>{{ $title }}</h2><a href="{{ route('tenant.pages.revisions', $page->id) }}" class="btn btn-secondary"><i class="bi bi-arrow-left"></i> Volver a revisiones</a></div>
